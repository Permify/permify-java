...
public interface PermissionLookupEntityRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:base.v1.PermissionLookupEntityRequest)
   ...
   * @return The metadata.
   */
  org.permify.grpc.PermissionLookupEntityRequestMetadata getMetadata();
  /**
   * <pre>
   * Metadata associated with this request, required.
   * </pre>
   ...
   * <code>.base.v1.PermissionLookupEntityRequestMetadata metadata = 2 [json_name = "metadata", (.validate.rules) = { ... }</code>
   */
  org.permify.grpc.PermissionLookupEntityRequestMetadataOrBuilder getMetadataOrBuilder();
