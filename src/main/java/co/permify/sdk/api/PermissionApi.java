...
public class PermissionApi {
   ...
   */
  public PermissionCheckResponse permissionsCheck(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionCheckBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PermissionCheckResponse> permissionsCheckWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionCheckBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<PermissionCheckResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PermissionCheckResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsCheckRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionCheckBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public PermissionExpandResponse permissionsExpand(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionExpandBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PermissionExpandResponse> permissionsExpandWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionExpandBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<PermissionExpandResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PermissionExpandResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsExpandRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull PermissionExpandBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PermissionLookupEntityResponse permissionsLookupEntity(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PermissionLookupEntityResponse> permissionsLookupEntityWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<PermissionLookupEntityResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PermissionLookupEntityResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsLookupEntityRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public StreamResultOfPermissionLookupEntityStreamResponse permissionsLookupEntityStream(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityStreamBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<StreamResultOfPermissionLookupEntityStreamResponse> permissionsLookupEntityStreamWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityStreamBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<StreamResultOfPermissionLookupEntityStreamResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<StreamResultOfPermissionLookupEntityStreamResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsLookupEntityStreamRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupEntityStreamBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PermissionLookupSubjectResponse permissionsLookupSubject(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupSubjectBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PermissionLookupSubjectResponse> permissionsLookupSubjectWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupSubjectBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<PermissionLookupSubjectResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PermissionLookupSubjectResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsLookupSubjectRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull LookupSubjectBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PermissionSubjectPermissionResponse permissionsSubjectPermission(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull SubjectPermissionBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PermissionSubjectPermissionResponse> permissionsSubjectPermissionWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull SubjectPermissionBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<PermissionSubjectPermissionResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PermissionSubjectPermissionResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder permissionsSubjectPermissionRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull SubjectPermissionBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
