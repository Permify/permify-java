...
public class BundleApi {
   ...
   */
  public BundleDeleteResponse bundleDelete(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleDeleteBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BundleDeleteResponse> bundleDeleteWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleDeleteBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<BundleDeleteResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BundleDeleteResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder bundleDeleteRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleDeleteBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BundleReadResponse bundleRead(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleReadBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BundleReadResponse> bundleReadWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleReadBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<BundleReadResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BundleReadResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder bundleReadRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleReadBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public BundleWriteResponse bundleWrite(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleWriteBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BundleWriteResponse> bundleWriteWithHttpInfo(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleWriteBody body) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<BundleWriteResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BundleWriteResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder bundleWriteRequestBuilder(@jakarta.annotation.Nonnull String tenantId, @jakarta.annotation.Nonnull BundleWriteBody body) throws ApiException {
    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
