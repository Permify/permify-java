 ...
 */
@JsonPropertyOrder({
  StringArrayValue.JSON_PROPERTY_DATA
})
...
public class StringArrayValue {
  ...
  public StringArrayValue data(List<String> data) {
    this.data = data;
    return this;
  }

  public StringArrayValue addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StringArrayValue stringArrayValue = (StringArrayValue) o;
    return Objects.equals(this.data, stringArrayValue.data);
  }
