...
public class Leaf {
  ...
  public Leaf computedUserSet(@jakarta.annotation.Nullable ComputedUserSet computedUserSet) {
  ...
  @JsonProperty(JSON_PROPERTY_COMPUTED_USER_SET)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComputedUserSet(@jakarta.annotation.Nullable ComputedUserSet computedUserSet) {
    this.computedUserSet = computedUserSet;
  }


  public Leaf tupleToUserSet(@jakarta.annotation.Nullable TupleToUserSet tupleToUserSet) {
  ...
  @JsonProperty(JSON_PROPERTY_TUPLE_TO_USER_SET)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTupleToUserSet(@jakarta.annotation.Nullable TupleToUserSet tupleToUserSet) {
    this.tupleToUserSet = tupleToUserSet;
  }


  public Leaf computedAttribute(@jakarta.annotation.Nullable ComputedAttribute computedAttribute) {
  ...
  public Leaf call(@jakarta.annotation.Nullable V1Call call) {
    this.call = call;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CALL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCall(@jakarta.annotation.Nullable V1Call call) {
    this.call = call;
  }
