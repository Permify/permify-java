...
public class Status {
  ...
  public Status code(@jakarta.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public Status message(@jakarta.annotation.Nullable String message) {
  ...
  public Status details(@jakarta.annotation.Nullable List<Any> details) {
  ...
  @JsonProperty(JSON_PROPERTY_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetails(@jakarta.annotation.Nullable List<Any> details) {
    this.details = details;
  }
      ...
      for (int i = 0; i < getDetails().size(); i++) {
        if (getDetails().get(i) != null) {
          joiner.add(String.format("%sdetails%s%s=%s", prefix, suffix,
              ...
              ApiClient.urlEncode(ApiClient.valueToString(getDetails().get(i)))));
        }
      }
    }
