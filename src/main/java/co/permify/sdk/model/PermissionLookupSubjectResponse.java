...
public class PermissionLookupSubjectResponse {
  ...
  public PermissionLookupSubjectResponse subjectIds(@jakarta.annotation.Nullable List<String> subjectIds) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBJECT_IDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubjectIds(@jakarta.annotation.Nullable List<String> subjectIds) {
    this.subjectIds = subjectIds;
  }


  public PermissionLookupSubjectResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
    ...
    if (getSubjectIds() != null) {
      for (int i = 0; i < getSubjectIds().size(); i++) {
        joiner.add(String.format("%ssubject_ids%s%s=%s", prefix, suffix,
            ...
            ApiClient.urlEncode(ApiClient.valueToString(getSubjectIds().get(i)))));
      }
    }
