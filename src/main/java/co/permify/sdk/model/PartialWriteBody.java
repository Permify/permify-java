...
public class PartialWriteBody {
  ...
  public PartialWriteBody metadata(@jakarta.annotation.Nullable SchemaPartialWriteRequestMetadata metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(@jakarta.annotation.Nullable SchemaPartialWriteRequestMetadata metadata) {
    this.metadata = metadata;
  }


  public PartialWriteBody partials(@jakarta.annotation.Nullable Map<String, Partials> partials) {
  ...
  @JsonProperty(JSON_PROPERTY_PARTIALS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPartials(@jakarta.annotation.Nullable Map<String, Partials> partials) {
    this.partials = partials;
  }
