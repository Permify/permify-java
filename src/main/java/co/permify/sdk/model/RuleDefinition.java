...
public class RuleDefinition {
  ...
  public RuleDefinition name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RuleDefinition arguments(@jakarta.annotation.Nullable Map<String, AttributeType> arguments) {
  ...
  @JsonProperty(JSON_PROPERTY_ARGUMENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setArguments(@jakarta.annotation.Nullable Map<String, AttributeType> arguments) {
    this.arguments = arguments;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXPRESSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpression(@jakarta.annotation.Nullable CheckedExpr expression) {
    this.expression = expression;
  }
