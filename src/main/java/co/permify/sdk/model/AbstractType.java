...
public class AbstractType {
  ...
  public AbstractType name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AbstractType parameterTypes(@jakarta.annotation.Nullable List<V1alpha1Type> parameterTypes) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETER_TYPES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParameterTypes(@jakarta.annotation.Nullable List<V1alpha1Type> parameterTypes) {
    this.parameterTypes = parameterTypes;
  }
