...
public class SchemaListBody {
  ...
  public SchemaListBody pageSize(@jakarta.annotation.Nullable Long pageSize) {
  ...
  public SchemaListBody continuousToken(@jakarta.annotation.Nullable String continuousToken) {
