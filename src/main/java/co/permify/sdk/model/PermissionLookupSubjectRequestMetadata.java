...
public class PermissionLookupSubjectRequestMetadata {
  ...
  public PermissionLookupSubjectRequestMetadata schemaVersion(@jakarta.annotation.Nullable String schemaVersion) {
  ...
  public PermissionLookupSubjectRequestMetadata snapToken(@jakarta.annotation.Nullable String snapToken) {
  ...
  public PermissionLookupSubjectRequestMetadata depth(@jakarta.annotation.Nullable Integer depth) {
    this.depth = depth;
    return this;
  }
