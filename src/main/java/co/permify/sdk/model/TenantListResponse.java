...
public class TenantListResponse {
  ...
  public TenantListResponse tenants(@jakarta.annotation.Nullable List<Tenant> tenants) {
  ...
  @JsonProperty(JSON_PROPERTY_TENANTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTenants(@jakarta.annotation.Nullable List<Tenant> tenants) {
    this.tenants = tenants;
  }


  public TenantListResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
