  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNullValue() != null) {
      joiner.add(String.format("%snullValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNullValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `boolValue` to the URL query string
    if (getBoolValue() != null) {
      joiner.add(String.format("%sboolValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBoolValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `int64Value` to the URL query string
    if (getInt64Value() != null) {
      joiner.add(String.format("%sint64Value%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getInt64Value()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `uint64Value` to the URL query string
    if (getUint64Value() != null) {
      joiner.add(String.format("%suint64Value%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUint64Value()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `doubleValue` to the URL query string
    if (getDoubleValue() != null) {
      joiner.add(String.format("%sdoubleValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDoubleValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `stringValue` to the URL query string
    if (getStringValue() != null) {
      joiner.add(String.format("%sstringValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStringValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `bytesValue` to the URL query string
    if (getBytesValue() != null) {
      joiner.add(String.format("%sbytesValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBytesValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `durationValue` to the URL query string
    if (getDurationValue() != null) {
      joiner.add(String.format("%sdurationValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDurationValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `timestampValue` to the URL query string
    if (getTimestampValue() != null) {
      joiner.add(String.format("%stimestampValue%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTimestampValue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
