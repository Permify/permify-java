...
public class RunBundleBody {
  ...
  public RunBundleBody name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RunBundleBody arguments(@jakarta.annotation.Nullable Map<String, String> arguments) {
