...
public class TupleFilter {
  ...
  public TupleFilter entity(@jakarta.annotation.Nullable EntityFilter entity) {
    this.entity = entity;
    return this;
  }
  ...
  public TupleFilter relation(@jakarta.annotation.Nullable String relation) {
  ...
  public TupleFilter subject(@jakarta.annotation.Nullable SubjectFilter subject) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBJECT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubject(@jakarta.annotation.Nullable SubjectFilter subject) {
    this.subject = subject;
  }
