...
public class V1Operation {
  ...
  public V1Operation relationshipsWrite(@jakarta.annotation.Nullable List<String> relationshipsWrite) {
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS_WRITE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationshipsWrite(@jakarta.annotation.Nullable List<String> relationshipsWrite) {
    this.relationshipsWrite = relationshipsWrite;
  }


  public V1Operation relationshipsDelete(@jakarta.annotation.Nullable List<String> relationshipsDelete) {
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS_DELETE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRelationshipsDelete(@jakarta.annotation.Nullable List<String> relationshipsDelete) {
    this.relationshipsDelete = relationshipsDelete;
  }


  public V1Operation attributesWrite(@jakarta.annotation.Nullable List<String> attributesWrite) {
  ...
  @JsonProperty(JSON_PROPERTY_ATTRIBUTES_WRITE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributesWrite(@jakarta.annotation.Nullable List<String> attributesWrite) {
    this.attributesWrite = attributesWrite;
  }


  public V1Operation attributesDelete(@jakarta.annotation.Nullable List<String> attributesDelete) {
  ...
  @JsonProperty(JSON_PROPERTY_ATTRIBUTES_DELETE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributesDelete(@jakarta.annotation.Nullable List<String> attributesDelete) {
    this.attributesDelete = attributesDelete;
  }
    ...
    if (getRelationshipsWrite() != null) {
      for (int i = 0; i < getRelationshipsWrite().size(); i++) {
        joiner.add(String.format("%srelationships_write%s%s=%s", prefix, suffix,
            ...
            ApiClient.urlEncode(ApiClient.valueToString(getRelationshipsWrite().get(i)))));
      }
    }
    ...
    if (getRelationshipsDelete() != null) {
      for (int i = 0; i < getRelationshipsDelete().size(); i++) {
        joiner.add(String.format("%srelationships_delete%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getRelationshipsDelete().get(i)))));
      }
    }
    ...
    if (getAttributesWrite() != null) {
      for (int i = 0; i < getAttributesWrite().size(); i++) {
        joiner.add(String.format("%sattributes_write%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getAttributesWrite().get(i)))));
      }
    }
    ...
    if (getAttributesDelete() != null) {
      for (int i = 0; i < getAttributesDelete().size(); i++) {
        joiner.add(String.format("%sattributes_delete%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getAttributesDelete().get(i)))));
      }
    }
