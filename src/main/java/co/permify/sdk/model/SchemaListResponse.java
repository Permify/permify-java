...
public class SchemaListResponse {
  ...
  public SchemaListResponse head(@jakarta.annotation.Nullable String head) {
    this.head = head;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HEAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHead(@jakarta.annotation.Nullable String head) {
    this.head = head;
  }


  public SchemaListResponse schemas(@jakarta.annotation.Nullable List<SchemaList> schemas) {
  ...
  @JsonProperty(JSON_PROPERTY_SCHEMAS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSchemas(@jakarta.annotation.Nullable List<SchemaList> schemas) {
    this.schemas = schemas;
  }


  public SchemaListResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getHead() != null) {
      joiner.add(String.format("%shead%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHead()))));
    }
