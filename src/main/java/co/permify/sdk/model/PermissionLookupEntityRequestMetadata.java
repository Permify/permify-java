...
public class PermissionLookupEntityRequestMetadata {
  ...
  public PermissionLookupEntityRequestMetadata schemaVersion(@jakarta.annotation.Nullable String schemaVersion) {
  ...
  public PermissionLookupEntityRequestMetadata snapToken(@jakarta.annotation.Nullable String snapToken) {
  ...
  public PermissionLookupEntityRequestMetadata depth(@jakarta.annotation.Nullable Integer depth) {
    this.depth = depth;
    return this;
  }
