...
public class PermissionDefinition {
  ...
  public PermissionDefinition name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PermissionDefinition child(@jakarta.annotation.Nullable Child child) {
    this.child = child;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHILD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChild(@jakarta.annotation.Nullable Child child) {
    this.child = child;
  }
