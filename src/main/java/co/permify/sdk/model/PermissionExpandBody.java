...
public class PermissionExpandBody {
  ...
  public PermissionExpandBody metadata(@jakarta.annotation.Nullable PermissionExpandRequestMetadata metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(@jakarta.annotation.Nullable PermissionExpandRequestMetadata metadata) {
    this.metadata = metadata;
  }


  public PermissionExpandBody entity(@jakarta.annotation.Nullable Entity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public PermissionExpandBody permission(@jakarta.annotation.Nullable String permission) {
  ...
  public PermissionExpandBody context(@jakarta.annotation.Nullable Context context) {
  ...
  public PermissionExpandBody arguments(@jakarta.annotation.Nullable List<Argument> arguments) {
