...
public class PermissionLookupEntityStreamResponse {
  ...
  public PermissionLookupEntityStreamResponse entityId(@jakarta.annotation.Nullable String entityId) {
  ...
  public PermissionLookupEntityStreamResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEntityId() != null) {
      joiner.add(String.format("%sentity_id%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEntityId()))));
    }
