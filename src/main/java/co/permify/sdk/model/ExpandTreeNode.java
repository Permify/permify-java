...
public class ExpandTreeNode {
  ...
  private ExpandTreeNodeOperation operation = ExpandTreeNodeOperation.OPERATION_UNSPECIFIED;
  ...
  public ExpandTreeNode operation(@jakarta.annotation.Nullable ExpandTreeNodeOperation operation) {
  ...
  @JsonProperty(JSON_PROPERTY_OPERATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOperation(@jakarta.annotation.Nullable ExpandTreeNodeOperation operation) {
    this.operation = operation;
  }


  public ExpandTreeNode children(@jakarta.annotation.Nullable List<Object> children) {
    this.children = children;
    return this;
  }

  public ExpandTreeNode addChildrenItem(Object childrenItem) {
  ...
  @JsonProperty(JSON_PROPERTY_CHILDREN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChildren(@jakarta.annotation.Nullable List<Object> children) {
    this.children = children;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getChildren() != null) {
      for (int i = 0; i < getChildren().size(); i++) {
        joiner.add(String.format("%schildren%s%s=%s", prefix, suffix,
