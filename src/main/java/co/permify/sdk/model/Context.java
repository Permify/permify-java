...
public class Context {
  ...
  public Context tuples(@jakarta.annotation.Nullable List<Tuple> tuples) {
    this.tuples = tuples;
    return this;
  }
  ...
  public Context attributes(@jakarta.annotation.Nullable List<Attribute> attributes) {
  ...
  public Context data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
