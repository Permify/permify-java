...
public class PermissionLookupEntityResponse {
  ...
  **/
  ...
  public PermissionLookupEntityResponse continuousToken(String continuousToken) {
    ...
    if (getEntityIds() != null) {
      for (int i = 0; i < getEntityIds().size(); i++) {
        joiner.add(String.format("%sentity_ids%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(String.valueOf(getEntityIds().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
