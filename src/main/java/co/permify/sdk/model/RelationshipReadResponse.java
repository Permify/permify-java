...
public class RelationshipReadResponse {
  ...
  public RelationshipReadResponse tuples(@jakarta.annotation.Nullable List<Tuple> tuples) {
    this.tuples = tuples;
    return this;
  }
  ...
  public RelationshipReadResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
