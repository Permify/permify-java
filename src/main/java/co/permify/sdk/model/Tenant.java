...
public class Tenant {
  ...
  public Tenant id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Tenant name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Tenant createdAt(@jakarta.annotation.Nullable OffsetDateTime createdAt) {
