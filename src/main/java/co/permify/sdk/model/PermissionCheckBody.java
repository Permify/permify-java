 ...
 */
@JsonPropertyOrder({
  PermissionCheckBody.JSON_PROPERTY_METADATA,
  PermissionCheckBody.JSON_PROPERTY_ENTITY,
  PermissionCheckBody.JSON_PROPERTY_PERMISSION,
  PermissionCheckBody.JSON_PROPERTY_SUBJECT,
  PermissionCheckBody.JSON_PROPERTY_CONTEXT,
  PermissionCheckBody.JSON_PROPERTY_ARGUMENTS
})
...
public class PermissionCheckBody {
  ...
  public PermissionCheckBody() { 
  }

  public PermissionCheckBody metadata(@jakarta.annotation.Nullable PermissionCheckRequestMetadata metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(@jakarta.annotation.Nullable PermissionCheckRequestMetadata metadata) {
    this.metadata = metadata;
  }


  public PermissionCheckBody entity(@jakarta.annotation.Nullable Entity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public PermissionCheckBody permission(@jakarta.annotation.Nullable String permission) {
  ...
  public PermissionCheckBody subject(@jakarta.annotation.Nullable Subject subject) {
  ...
  public PermissionCheckBody context(@jakarta.annotation.Nullable Context context) {
  ...
  public PermissionCheckBody arguments(@jakarta.annotation.Nullable List<Argument> arguments) {
    this.arguments = arguments;
    return this;
  }

  public PermissionCheckBody addArgumentsItem(Argument argumentsItem) {
  ...
  /**
   * Return true if this Permission.CheckBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PermissionCheckBody permissionCheckBody = (PermissionCheckBody) o;
    return Objects.equals(this.metadata, permissionCheckBody.metadata) &&
        Objects.equals(this.entity, permissionCheckBody.entity) &&
        Objects.equals(this.permission, permissionCheckBody.permission) &&
        Objects.equals(this.subject, permissionCheckBody.subject) &&
        Objects.equals(this.context, permissionCheckBody.context) &&
        Objects.equals(this.arguments, permissionCheckBody.arguments);
  }
  ...
  public String toString() {
    ...
    sb.append("class PermissionCheckBody {\n");
