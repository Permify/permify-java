...
public class AttributeReadResponse {
  ...
  public AttributeReadResponse attributes(@jakarta.annotation.Nullable List<Attribute> attributes) {
  ...
  public AttributeReadResponse continuousToken(@jakarta.annotation.Nullable String continuousToken) {
