...
public class StreamResultOfPermissionLookupEntityStreamResponse {
  ...
  public StreamResultOfPermissionLookupEntityStreamResponse result(@jakarta.annotation.Nullable PermissionLookupEntityStreamResponse result) {
    this.result = result;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResult(@jakarta.annotation.Nullable PermissionLookupEntityStreamResponse result) {
    this.result = result;
  }


  public StreamResultOfPermissionLookupEntityStreamResponse error(@jakarta.annotation.Nullable Status error) {
    this.error = error;
    return this;
  }
