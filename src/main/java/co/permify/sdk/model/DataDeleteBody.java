...
public class DataDeleteBody {
  ...
  public DataDeleteBody tupleFilter(@jakarta.annotation.Nullable TupleFilter tupleFilter) {
  ...
  @JsonProperty(JSON_PROPERTY_TUPLE_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTupleFilter(@jakarta.annotation.Nullable TupleFilter tupleFilter) {
    this.tupleFilter = tupleFilter;
  }


  public DataDeleteBody attributeFilter(@jakarta.annotation.Nullable AttributeFilter attributeFilter) {
  ...
  @JsonProperty(JSON_PROPERTY_ATTRIBUTE_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttributeFilter(@jakarta.annotation.Nullable AttributeFilter attributeFilter) {
    this.attributeFilter = attributeFilter;
  }
