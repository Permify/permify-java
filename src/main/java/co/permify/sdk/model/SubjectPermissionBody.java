...
public class SubjectPermissionBody {
  ...
  public SubjectPermissionBody metadata(@jakarta.annotation.Nullable PermissionSubjectPermissionRequestMetadata metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(@jakarta.annotation.Nullable PermissionSubjectPermissionRequestMetadata metadata) {
    this.metadata = metadata;
  }


  public SubjectPermissionBody entity(@jakarta.annotation.Nullable Entity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public SubjectPermissionBody subject(@jakarta.annotation.Nullable Subject subject) {
  ...
  public SubjectPermissionBody context(@jakarta.annotation.Nullable Context context) {
